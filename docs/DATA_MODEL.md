...
multi-blank заданий, полный эталонный шаблон A1–C1, обратные ссылки
...
Расширенный формат A1–C1 хранится в том же `ContentItem.data`: structured theory
...
с будущими расширениями, но обязательны для A1–C1 на уровне `content:check`. Серверная проверка
