...
multi-blank заданий, полный эталонный шаблон A1–B2, обратные ссылки
...
Расширенный формат A1–B2 хранится в том же `ContentItem.data`: structured theory
...
с C1, но обязательны для A1–B2 на уровне `content:check`. Серверная проверка
