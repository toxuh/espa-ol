...
multi-blank заданий, полный эталонный шаблон A1–A2, обратные ссылки
...
Расширенный формат A1–A2 хранится в том же `ContentItem.data`: structured theory
...
с B1–C1, но обязательны для A1–A2 на уровне `content:check`. Серверная проверка
