...
multi-blank заданий, полный эталонный шаблон A1–B1, обратные ссылки
...
Расширенный формат A1–B1 хранится в том же `ContentItem.data`: structured theory
...
с B2–C1, но обязательны для A1–B1 на уровне `content:check`. Серверная проверка
