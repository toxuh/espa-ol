...
Исходный автономный HTML-прототип хранится локально в игнорируемой папке `temp/` и остаётся эталоном функционального поведения. Его учебный контент перенесён в типизированный модульный каталог с runtime-валидацией и воспроизводимым seed, а основной пользовательский цикл уже работает на Next.js и PostgreSQL.
...
- Prisma и PostgreSQL;
- Docker Compose;
- домашний NAS Synology DS923+ с прямым LAN-доступом по host-порту `8888`;
